...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
    ...
    Vec2f _offset = this.get_Vec2f("shop offset");//Quick fix for bad offsets.
...
{
    //For handling delayedCreateMenu
    u8 delay = this.get_u8("s_delay");
    if(delay == 0)
    {
