...
namespace EType
{
    ...
    u32 CreateEntity(CRules@ rules, itpol::Pool@ it_pol, array<u16> com_type_array, bool default_coms = true)
    {
    ...
    shared bool EntityHasType(EType::Entity@ ent, u16 type, u16 &out pos)
    {
    ...
    shared bool EntityHasTypes(EType::Entity@ ent, array<u16> com_type_array, array<u16> &out pos)
    {
        bool all_found = true;
    ...
    shared bool EntityGetComponents(EType::Entity@ ent, array<u16> com_type_array, array<CType::IComponent@> com_array)
    {
        bool all_found = true;
